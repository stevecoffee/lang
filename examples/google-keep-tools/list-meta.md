...
Kind: collection (file `list-meta.md` + directory `list-meta/` — does not compile to a code file)
...
- Collection file is `list-meta.md` (sibling of directory `list-meta/`); children are only inside `list-meta/`.
